...
const { index, show, store, destroy, update, loginDriver, validateDriver, driverBonus, resetPassword } = require('../controllers/driver.controller')
...
driver.post('/resetPassword', resetPassword)
