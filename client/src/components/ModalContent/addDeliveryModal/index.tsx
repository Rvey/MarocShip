...
const AddDeliveryModal: React.FC<AddDeliveryModalProps> = ({ isOpen, setIsOpen }) => {
    return (
                ...
                <div className="min-h-screen px-4 text-center ">
                    ...
                    >
                        <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl dark:bg-gray-700 ">
                            <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900 dark:text-white mb-6">
                                Add Delivery
                            </Dialog.Title>

                            <AddDeliveryForm setIsOpen={setIsOpen} />
                        </div>
                    </Transition.Child>
                </div>
            </Dialog>
