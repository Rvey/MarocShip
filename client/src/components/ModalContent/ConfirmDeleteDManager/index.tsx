...
const ConfirmDeleteDeliveryManager: React.FC<ConfirmDDProps> = ({ isOpen, setIsOpen, deliveryMId }) => {
    const [deleteDelivery] = useDeleteDeliveryManagerMutation();
    const { refetch } = useGetDeliveryManagersQuery();
    const DeleteDelivery = (deliveryMId: any) => {
        deleteDelivery(deliveryMId)
                        ...
                        <div className="inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl dark:bg-gray-700">
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <div className="p-6 pt-0 text-center">
                                    ...
                                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this Delivery Manager?</h3>
                                    <button
                                        onClick={() => DeleteDelivery(deliveryMId)}
                                        type="button"
...
export default ConfirmDeleteDeliveryManager;
