...
import { useAcceptDeliveryMutation, useGetDeliveriesQuery } from '../../../Redux/services/deliveries';

interface ConfirmDProps {
    isOpen: boolean;
    setIsOpen: (val: boolean) => void;
    deliveryId: string;
}

const ConfirmAcceptDelivery: React.FC<ConfirmDProps> = ({ isOpen, setIsOpen, deliveryId }) => {
    const { refetch } = useGetDeliveriesQuery();
    const [acceptDelivery] = useAcceptDeliveryMutation();
    const Recruits = (id: any) => {
        acceptDelivery({ id: id , driverId: '61f54965b18b7fd9fae7753c' })
...
export default ConfirmAcceptDelivery;
